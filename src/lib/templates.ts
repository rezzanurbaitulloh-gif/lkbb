...
export const BUILTIN_TEMPLATES: EventTemplate[] = [
  ...
  },
  {
    ...
    description: "Warisan Jawa autentik — Prambanan sunset, Gunungan Kayon Tropenmuseum & Batik Mega Mendung (Wikimedia Commons, CC BY-SA). Plek referensi, bukan buat sendiri.",
    category: "heritage",
